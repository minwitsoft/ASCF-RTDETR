...
from codeproject.data.augment import LetterBox
from codeproject.engine.predictor import BasePredictor
from codeproject.engine.results import Results
from codeproject.utils import ops
...
class RTDETRPredictor(BasePredictor):
    ...
    Example:
        ```python
        from codeproject.utils import ASSETS
        from codeproject.models.rtdetr import RTDETRPredictor
