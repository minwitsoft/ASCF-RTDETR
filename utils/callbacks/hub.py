...
from codeproject.hub.utils import HUB_WEB_ROOT, PREFIX, events
...
def on_fit_epoch_end(trainer):
    ...
    if session:
        ...
        all_plots = {**trainer.label_loss_items(trainer.tloss, prefix='images'), **trainer.metrics}
        if trainer.epoch == 0:
            from codeproject.utils.torch_utils import model_info_for_loggers
