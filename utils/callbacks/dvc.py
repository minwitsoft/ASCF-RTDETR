...
from codeproject.utils import LOGGER, SETTINGS, TESTS_RUNNING, checks
...
def on_pretrain_routine_end(trainer):
    ...
    _log_plots(trainer.plots, 'images')
...
def on_fit_epoch_end(trainer):
    ...
    if live and _training_epoch:
        all_metrics = {**trainer.label_loss_items(trainer.tloss, prefix='images'), **trainer.metrics, **trainer.lr}
