...
from codeproject.utils.metrics import OKS_SIGMA
from codeproject.utils.ops import crop_mask, xywh2xyxy, xyxy2xywh
from codeproject.utils.tal import TaskAlignedAssigner, dist2bbox, make_anchors
    ...
    def __call__(self, preds, batch):
        ...
        try:
            ...
            raise TypeError('ERROR ❌ segment dataset incorrectly formatted or not a segment dataset.\n'
                            ...
                            "i.e. 'yolo images model=yolov8n-seg.pt data=coco128.yaml'.\nVerify your dataset is a "
