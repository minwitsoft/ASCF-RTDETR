...
from codeproject.utils import LOGGER, TQDM, checks, clean_url, emojis, is_online, url2file

# Define Ultralytics GitHub assets maintained at https://github.com/ultralytics/assets
GITHUB_ASSETS_REPO = 'codeproject/assets'
...
def delete_dsstore(path, files_to_delete=('.DS_Store', '__MACOSX')):
    ...
    Example:
        ```python
        from codeproject.utils.downloads import delete_dsstore
...
def zip_directory(directory, compress=True, exclude=('.DS_Store', '__MACOSX'), progress=True):
    ...
    Example:
        ```python
        from codeproject.utils.downloads import zip_directory
...
def unzip_file(file, path=None, exclude=('.DS_Store', '__MACOSX'), exist_ok=False, progress=True):
    ...
    Example:
        ```python
        from codeproject.utils.downloads import unzip_file
...
def get_google_drive_file_info(link):
    ...
    Example:
        ```python
        from codeproject.utils.downloads import get_google_drive_file_info
...
def get_github_assets(repo='codeproject/assets', version='latest', retry=False):
...
def attempt_download_asset(file, repo='codeproject/assets', release='v0.0.0'):
    """
    Attempt file download from GitHub release assets if not found locally.

    release = 'latest', 'v6.2', etc.
    """
    from codeproject.utils import SETTINGS  # scoped for circular import
