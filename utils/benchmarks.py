...
Usage:
    from codeproject.utils.benchmarks import ProfileModels, benchmark
...
from codeproject.cfg import TASK2DATA, TASK2METRIC
from codeproject.engine.exporter import export_formats
from codeproject.utils import ASSETS, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR
from codeproject.utils.checks import check_requirements, check_yolo
from codeproject.utils.files import file_size
...
class ProfileModels:
    ...
    Example:
        ```python
        from codeproject.utils.benchmarks import ProfileModels
