...
from codeproject.utils import DEFAULT_CFG, LOGGER, callbacks, colorstr, remove_colorstr, yaml_print, yaml_save
from codeproject.utils.plotting import plot_tune_results
    ...
    def __call__(self, model=None, iterations=10, cleanup=True):
        ...
        for i in range(iterations):
            ...
            try:
                ...
                cmd = ['yolo', 'images', *(f'{k}={v}' for k, v in train_args.items())]
